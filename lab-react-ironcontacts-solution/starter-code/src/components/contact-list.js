    ...
    showContacts(){
        return this.state.firstVisibleContacts.map((eachContact, index)=>{
          return (
            <tr key={index}>
                ...
                <td>
                    <button className="btn btn-secondary" onClick={()=>this.deleteContact(index)}>Delete</button>
                </td>
            </tr>
           )
        })
      ...
      render() {
        return (
          ...
          <button className="btn btn-secondary" onClick={()=>this.addRandomContact()}>Add random</button>
          <button className="btn btn-primary" onClick={()=>this.sortContacts("popularity")}>Sort by popularity</button>
          <button className="btn btn-success" onClick={()=>this.sortContacts("name")}>Sort by name</button>
